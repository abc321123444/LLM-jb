...
sys.stdout = Logger('./Result_syy/class2_result/keyword_woadv_suffix.log', sys.stdout)
...
class MiniGPT(nn.Module):
    def __init__(self, train_num):
        ...
        print("test_set: ",self.test_goal_index)
        rr = 0
...
# 保存为.png图像
random_init_save_path = "./Result_random_init_image/LLaMA2/7Financial/"+"round_"+round+".png"
#tensor_to_pil.save(random_init_save_path)

images = []
images.append(image)
adv_img = attack(images, model.shift_labels)
save_img_path = "./Result_random_init_Noise_img_4.18/LLaMA2/7Financial/" + attack_mode + "_" + str(
    attack_power) + "_" + str(attack_iters) + "_iters_Randominit_" + round + ".png"
