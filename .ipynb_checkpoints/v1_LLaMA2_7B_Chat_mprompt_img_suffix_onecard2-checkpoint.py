...
class MiniGPT(nn.Module):
    def __init__(self, class_tag):
        ...
        if class_tag == "S1":
            ...
            self.train_goal_index = [505, 220, 31, 349, 506, 327, 510, 475, 429, 371, 214, 85, 421, 504, 512]
            self.test_prompt_index = [129, 177, 184, 354, 408, 459, 466, 509, 537, 24, 147, 250, 251, 321, 360, 433, 507, 508]
